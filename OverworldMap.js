class OverworldMap {
  constructor(config) {
    this.overworld = null;
    this.configObjects = config.configObjects; // Conteúdo da configuração
    this.gameObjects = {}; // Começa vazio, instâncias de objetos ao vivo no mapa são adicionadas aqui
  ...
  isSpaceTaken(currentX, currentY, direction) {
    ...
    // Verifica se há objetos que correspondem
